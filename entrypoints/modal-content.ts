...
function showTextPreviewModal(job: ProcessingJob) {
	...
	instructions.textContent = 'Review and edit the extracted text below. Make any necessary corrections before generating speech.';
...
function hideTextPreviewModal() {
	const existingModal = window.listenLaterModal || document.getElementById('listen-later-modal-overlay');
	if (existingModal) {
